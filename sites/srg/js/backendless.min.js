...
(c=b,b=u);this.success=function(b){a&&a.call(c,b)};this.fault=function(a){b&&b.call(c,a)}}function t(){this.properties=[];this.url=this.options=this.condition=null}function A(a){this.model=a;this.className=w.call(a);"string"===(typeof a).toLowerCase()&&(this.className=a);if(!this.className)throw"Class name should be specified";this.restUrl=e.appPath+"/data/"+this.className}function H(){}function I(){this.restUrl=e.appPath+"/geo"}function B(){}function C(a){this.eventHandlers={};this.restUrl=a;this.timeout=
this.timer=0;this.interval=1E3;this.xhr=null;this.needReconnect=!0;this.responder=new n(this.onMessage,this.onError,this);this.poll()}function D(a){var b=this;this.reconnectWithPolling=!0;try{var c=this.socket=new J(a);c.onopen=function(){return b.sockOpen()};c.onerror=function(a){return b.sockError(a)};c.onclose=function(a){b.onSocketClose()};c.onmessage=function(a){return b.onMessage(a)}}catch(d){setTimeout(function(){b.onSocketClose()},100)}}function E(a){this.channelName=a.channelName;this.options=
a.options;this.channelProperties=a.channelProperties;this.subscriptionId=null;this.restUrl=a.restUrl+"/"+a.channelName;this.responder=a.responder||u;this._subscribe(a.onSubscribe)}function K(){this.restUrl=e.appPath+"/messaging";this.channelProperties={}}function L(a,b,c){var d;d="--"+c;d+="\r\n";d+='Content-Disposition: form-data; name="file"';d+='; filename="'+a+'"';d+="\r\n";d+="Content-Type: application/octet-stream";d+="\r\n";d+="\r\n";d+=b;d+="\r\n";d+="--";d+=c;d+="--";return d+="\r\n"}function S(a){var b=
new XMLHttpRequest,c="-backendless-multipart-form-boundary-"+(new Date).getTime();a=L(this.fileName,a.target.result,c);b.open("POST",this.uploadPath,!0);b.setRequestHeader("content-type","multipart/form-data; boundary="+c);b.setRequestHeader("application-id",e.applicationId);b.setRequestHeader("secret-key",e.secretKey);b.setRequestHeader("application-type","JS");null!==v&&b.setRequestHeader("uiState",v);var d=this.asyncHandler;d&&(b.onreadystatechange=function(){4==b.readyState&&(200<=b.status&&300>
b.status?d.success(JSON.parse(b.responseText)):d.fault(JSON.parse(b.responseText)))});b.sendAsBinary(a);if(d)return b;if(200<=b.status&&300>b.status)return b.responseText?JSON.parse(b.responseText):!0;throw function(a){var b={};try{b=JSON.parse(a.responseText)}catch(c){b.message=a.responseText}b.statusCode=a.status;return b}(b);}function T(a){var b=new XMLHttpRequest,c="-backendless-multipart-form-boundary-"+(new Date).getTime();L(this.fileName,a.target.result,c);b.open("PUT",this.uploadPath,!0);
...
JSON.parse(b.responseText):!0;throw function(a){var b={};try{b=JSON.parse(a.responseText)}catch(c){b.message=a.responseText}b.statusCode=a.status;return b}(b);}function M(){this.restUrl=e.appPath+"/files"}function x(){this.restUrl=e.appPath+"/commerce/googleplay"}function F(){this.restUrl=e.appPath+"/servercode/events"}NodeDevice={name:"NODEJS",platform:"NODEJS",uuid:"someId",version:"1"};h()||(encodeURIComponent=function(a){return escape(a)});var e=this.Backendless||{},u=function(){};this.Backendless=
e;Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var c;if(null==this)throw new TypeError('"this" is null or not defined');var d=Object(this),f=d.length>>>0;if(0===f)return-1;c=+b||0;Infinity===Math.abs(c)&&(c=0);if(c>=f)return-1;for(c=Math.max(0<=c?c:f-Math.abs(c),0);c<f;){if(c in d&&d[c]===a)return c;c++}return-1});var U=Object.prototype.hasOwnProperty,N=Array.prototype.forEach,V=Array.isArray,J=null;e.VERSION="0.2";e.serverURL="https://api.backendless.com";(function(){try{"undefined"==
typeof XMLHttpRequest.prototype.sendAsBinary&&(XMLHttpRequest.prototype.sendAsBinary=function(a){for(var c=new ArrayBuffer(a.length),c=new Uint8Array(c,0),d=0;d<a.length;d++)c[d]=a.charCodeAt(d)&255;this.send(c)})}catch(a){}})();var W=function(){var a=h()?navigator.userAgent.toLowerCase():"NodeJS",b=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||0>a.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||
[],a=b[1]||"",b=b[2]||"0",c={};a&&(c[a]=!0,c.version=b);return c}(),v=null;e.browser=W;var g=e.Utils={isObject:function(a){return a===Object(a)},isString:function(a){return"String"===Object.prototype.toString.call(a).slice(8,-1)},isNumber:function(a){return"Number"===Object.prototype.toString.call(a).slice(8,-1)},isFunction:function(a){return"Function"===Object.prototype.toString.call(a).slice(8,-1)},isBoolean:function(a){return"Boolean"===Object.prototype.toString.call(a).slice(8,-1)},isDate:function(a){return"Date"===
Object.prototype.toString.call(a).slice(8,-1)}};g.isArray=V||function(a){return"Array"===Object.prototype.toString.call(a).slice(8,-1)};g.addEvent=function(a,b,c){b.addEventListener?b.addEventListener(a,c,!1):b.attachEvent?b.attachEvent("on"+a,c):b[a]=c};g.isEmpty=function(a){if(null==a)return!0;if(g.isArray(a)||g.isString(a))return 0===a.length;for(var b in a)if(a.hasOwnProperty(b)&&void 0!==a[b]&&null!==a[b])return!1;return!0};g.removeEvent=function(a,b){b.removeEventListener?b.removeEventListener(a,
null,!1):b.detachEvent?b.detachEvent("on"+a,null):b[a]=null};g.forEach=function(a,b,c){if(a)if(N&&a.forEach===N)a.forEach(b,c);else if(a.length===+a.length)for(var d=0,f=a.length;d<f&&!(d in a&&b.call(c,a[d],d,a)===breaker);d++);else for(d in a)if(U.call(a,d)&&b.call(c,a[d],d,a)===breaker)break};e.setUIState=function(a){if(void 0===a)throw Error("UI state name must be defined or explicitly set to null");v=null===a?null:a};e._ajax_for_browser=function(a){var b=["cacheOnly","remoteDataOnly","fromCacheOrRemote",
...
e.LocalCache.flushExpired();e.Async=n;t.prototype={addProperty:function(a){this.properties=this.properties||[];this.properties.push(a)}};e.DataQuery=t;A.prototype={_extractQueryOptions:function(a){var b=[];if("undefined"!=typeof a.pageSize){if(1>a.pageSize||100<a.pageSize)throw Error("PageSize can not be less then 1 or greater than 100");b.push("pageSize="+encodeURIComponent(a.pageSize))}if(a.offset){if(0>a.offset)throw Error("Offset can not be less then 0");b.push("offset="+encodeURIComponent(a.offset))}a.sortBy&&
(g.isString(a.sortBy)?b.push("sortBy="+encodeURIComponent(a.sortBy)):g.isArray(a.sortBy)&&b.push("sortBy="+z(a.sortBy)));a.relationsDepth&&g.isNumber(a.relationsDepth)&&b.push("relationsDepth="+encodeURIComponent(Math.floor(a.relationsDepth)));a.relations&&g.isArray(a.relations)&&b.push("loadRelations="+(a.relations.length?z(a.relations):"*"));return b.join("&")},_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){var b=
...
a.url="first";return this.find.apply(this,[a].concat(Array.prototype.slice.call(arguments)))},findLast:function(){var a=this._buildArgsObject.apply(this,arguments);a.url="last";return this.find.apply(this,[a].concat(Array.prototype.slice.call(arguments)))}};var G={},Y={save:function(a,b,c){var d=l(arguments);if(g.isString(a))return e._ajax({method:"POST",url:e.appPath+"/data/"+a,data:JSON.stringify(b),isAsync:!1,asyncHandler:d});if(g.isObject(a))return(new A(a)).save(a,b,c)},of:function(a){var b=
w.call(a),c=G[b];c||(c=new A(a),G[b]=c);return c},describe:function(a,b){a=g.isString(a)?a:w.call(a);var c=l(arguments);return e._ajax({method:"GET",url:e.appPath+"/data/"+a+"/properties",isAsync:null!=c,asyncHandler:c})}};H.prototype={___class:"Users"};e.User=H;var p=null,O=function(){this.restUrl=e.appPath+"/users"};O.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){try{c=JSON.parse(c)}catch(d){}p=b._parseResponse(c);a.success(b._getUserFromResponse(p))},function(b){a.fault(b)})},
...
logout:function(a){var b=l(arguments),c=null!=b,d=c?b.fault:null,f=c?b.success:null,m=function(){e.LocalCache.remove("user-token");e.LocalCache.remove("current-user");p=null},k=function(){m();g.isFunction(f)&&f()},h=function(a){g.isObject(a)&&-1!=[3064,3091,3090,3023].indexOf(a.code)?(m(),g.isFunction(f)&&f()):g.isFunction(d)&&d(a)};b&&(b.fault=h,b.success=k);try{var y=e._ajax({method:"GET",url:this.restUrl+"/logout",isAsync:c,asyncHandler:b})}catch(n){h(n)}if(c)return y;m()},getCurrentUser:function(){return e.LocalCache.get("current-user")?
...
y=b||c?{}:null;b&&(y.fieldsMapping=b);c&&(y.permissions=c);e._ajax({method:"POST",url:this.restUrl+"/social/oauth/"+a.toLowerCase()+"/request_url",isAsync:!0,asyncHandler:h,data:JSON.stringify(y)})},loginWithFacebookSdk:function(a,b){if(!FB)throw Error("Facebook SDK not found");var c=this;FB.getLoginStatus(function(d){"connected"===d.status?c._sendFacebookLoginRequest(c,d,a,b):FB.login(function(d){c._sendFacebookLoginRequest(c,d,a,b)})})},_sendFacebookLoginRequest:function(a,b,c,d){"connected"===
...
b,isAsync:d,asyncHandler:c});else try{return e._ajax({method:"GET",url:e.serverURL+"/"+e.appVersion+"/users/isvalidusertoken/"+b})?!0:!1}catch(f){return!1}else return e.UserService.getCurrentUser()?!0:!1}};I.prototype={UNITS:{METERS:"METERS",KILOMETERS:"KILOMETERS",MILES:"MILES",YARDS:"YARDS",FEET:"FEET"},_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){a=a.collection;s(a,this);return a},_load:function(a,
...
z(a)},includeMetadata:function(a){return"includemetadata="+a},pageSize:function(a){if(1>a||100<a)throw Error("PageSize can not be less then 1 or greater than 100");return"pagesize="+a},offset:function(a){if(0>a)throw Error("Offset can not be less then 0");return"offset="+a},relativeFindPercentThreshold:function(a){if(0>=a)throw Error("Threshold can not be less then or equal 0");return"relativeFindPercentThreshold="+a},relativeFindMetadata:function(a){return"relativeFindMetadata="+encodeURIComponent(JSON.stringify(a))},
condition:function(a){return"whereClause="+encodeURIComponent(a)},degreePerPixel:function(a){return"dpp="+a},clusterGridSize:function(a){return"clustergridsize="+a}},addPoint:function(a,b){if(void 0===a.latitude||void 0===a.longitude)throw"Latitude or longitude not a number";a.categories=a.categories||["Default"];a.categories=g.isArray(a.categories)?a.categories:[a.categories];var c=l(arguments),d=function(a){return new n(function(b){var c=b.geopoint,d=new GeoPoint;d.categories=c.categories;d.latitude=
c.latitude;d.longitude=c.longitude;d.metadata=c.metadata;d.objectId=c.objectId;b.geopoint=d;a.success(b)},function(b){a.fault(b)})};if(null!=c)var f=!0,c=d(c);d="lat="+a.latitude;d+="&lon="+a.longitude;a.categories&&(d+="&categories="+z(a.categories));a.metadata&&(d+="&metadata="+JSON.stringify(a.metadata));return e._ajax({method:"PUT",url:this.restUrl+"/points?"+d,isAsync:f,asyncHandler:c})},findUtil:function(a,b){var c=a.url,d=l(arguments),f=!1;if(a.searchRectangle&&a.radius)throw Error("Inconsistent geo query. Query should not contain both rectangle and radius search parameters.");
...
else throw Error("Latitude and longitude should be provided to search in radius");var c=c.replace(/\?&/g,"?"),k=this;g=function(b){return new n(function(c){for(var d=c.collection.data,e=0;e<d.length;e++){var f=null;d[e].hasOwnProperty("totalPoints")?(f=new GeoCluster,f.totalPoints=d[e].totalPoints,f.geoQuery=a):f=new GeoPoint;f.categories=d[e].categories;f.latitude=d[e].latitude;f.longitude=d[e].longitude;f.metadata=d[e].metadata;f.objectId=d[e].objectId;c.collection.data[e]=f}c=k._parseResponse(c);
b.success(c)},function(a){b.fault(a)})};null!=d&&(f=!0,d=g(d,c));c=e._ajax({method:"GET",url:c,isAsync:f,asyncHandler:d});return f?c:this._parseResponse(c)},find:function(a,b){a.url=this.restUrl;return this.findUtil(a,b)},loadMetadata:function(a){var b=this.restUrl+"/points/";if(a.objectId)if(a instanceof GeoCluster)if(a.geoQuery instanceof BackendlessGeoQuery){var b=b+(a.objectId+"/metadata?"),c;for(c in a.geoQuery)a.geoQuery.hasOwnProperty(c)&&(this._findHelpers.hasOwnProperty(c)&&void 0!=a.geoQuery[c])&&
(b+="&"+this._findHelpers[c](a.geoQuery[c]))}else throw Error("Invalid GeoCluster object. Make sure to obtain an instance of GeoCluster using the Backendless.Geo.find API");else if(a instanceof GeoPoint)b+=a.objectId+"/metadata";else throw Error("Method argument must be a valid instance of GeoPoint or GeoCluster persisted on the server");else throw Error("Method argument must be a valid instance of GeoPoint or GeoCluster persisted on the server");return e._ajax({method:"GET",url:b})},relativeFind:function(a,
b){if(a.relativeFindMetadata&&a.relativeFindPercentThreshold)return a.url=this.restUrl+"/relative",this.findUtil(a,b);throw Error("Inconsistent geo query. Query should contain both relativeFindPercentThreshold and relativeFindMetadata");},addCategory:function(a,b){if(!a)throw Error("Category name is required.");var c=l(arguments),c=e._ajax({method:"PUT",url:this.restUrl+"/categories/"+a,isAsync:null!=c,asyncHandler:c});return"undefined"===typeof c.result?c:c.result},getCategories:function(a){var b=
...
var c=g.isString(a)?a:a.objectId,d=l(arguments);try{var f=e._ajax({method:"DELETE",url:this.restUrl+"/points/"+c,isAsync:null!=d,asyncHandler:d})}catch(m){if(404==m.statusCode)f=!1;else throw m;}return"undefined"===typeof f.result?f:f.result}};B.prototype={on:function(a,b){if(!a)throw Error("Event name not specified");if(!b)throw Error("Handler not specified");this.eventHandlers[a]=this.eventHandlers[a]||[];this.eventHandlers[a].push(b)},fireEvent:function(a,b){var c=this.eventHandlers[a]||[],d,e;
e=0;for(d=c.length;e<d;++e)c[e](b)}};C.prototype=new B;q(C.prototype,{onMessage:function(a){clearTimeout(this.timeout);var b=this;this.timer=setTimeout(function(){b.poll()},this.interval);this.fireEvent("messageReceived",a)},poll:function(){var a=this;this.timeout=setTimeout(function(){a.onTimeout()},3E4);this.xhr=e._ajax({method:"GET",url:this.restUrl,isAsync:!0,asyncHandler:this.responder})},close:function(){clearTimeout(this.timer);clearTimeout(this.timeout);this.needReconnect=!1;this.xhr&&this.xhr.abort()},
onTimeout:function(){this.xhr&&this.xhr.abort()},onError:function(){clearTimeout(this.timer);clearTimeout(this.timeout);if(this.needReconnect){var a=this;this.xhr=null;this.timer=setTimeout(function(){a.poll()},this.interval)}}});D.prototype=new B;q(D.prototype,{onMessage:function(){this.fireEvent("messageReceived",data)},onSocketClose:function(a){this.reconnectWithPolling&&this.fireEvent("socketClose",a)},close:function(){this.reconnectWithPolling=!1;this.socket.close()}});E.prototype={_subscribe:function(a){var b=
l(arguments),c=null!=b,d=this,f=new n(function(a){d.subscriptionId=a.subscriptionId;d._startSubscription()},function(a){b.fault(a)}),f=e._ajax({method:"POST",url:this.restUrl+"/subscribe",isAsync:c,data:JSON.stringify(this.options),asyncHandler:f});c||(this.subscriptionId=f.subscriptionId,this._startSubscription())},_startSubscription:function(){var a=this;J?(this.proxy=new D(this.channelProperties.websocket+"/"+this.subscriptionId),this.proxy.on("socketClose",function(){a._switchToPolling()}),this.proxy.on("messageReceived",
function(){a.responder()})):this._switchToPolling();this._startSubscription=u},cancelSubscription:function(){this.proxy&&this.proxy.close();this._startSubscription=u},_switchToPolling:function(){this.proxy=new C(this.restUrl+"/"+this.subscriptionId);var a=this;this.proxy.on("messageReceived",function(b){b.messages.length&&a.responder(b)})}};K.prototype={_getProperties:function(a,b){var c=l(arguments),d=null!=c,f=this.channelProperties[a];if(f)return d&&b.success(f),f;c=e._ajax({method:"GET",url:this.restUrl+
"/"+a+"/properties",isAsync:d,asyncHandler:c});return this.channelProperties[a]=c},subscribe:function(a,b,c,d){var e=l(arguments);if(null!=e){var g=this,k=new n(function(k){d.success(new E({channelName:a,options:c,channelProperties:k,responder:b,restUrl:g.restUrl,onSubscribe:e}))},function(a){e.fault(a)});this._getProperties(a,k)}else return k=this._getProperties(a),new E({channelName:a,options:c,channelProperties:k,responder:b,restUrl:this.restUrl})},publish:function(a,b,c,d,f){var g=l(arguments),
k=null!=g,h={message:b};if(c){if(!(c instanceof PublishOptions))throw"Use PublishOption as publishOptions argument";q(h,c)}if(d){if(!(d instanceof DeliveryOptions))throw"Use DeliveryOptions as deliveryTarget argument";q(h,d)}return e._ajax({method:"POST",url:this.restUrl+"/"+a,isAsync:k,asyncHandler:g,data:JSON.stringify(h)})},sendEmail:function(a,b,c,d,f){var h=l(arguments),k=null!=h,n={};if(a&&!g.isEmpty(a)&&g.isString(a))n.subject=a;else throw"Subject is required parameter and must be a nonempty string";
if(b instanceof Bodyparts&&!g.isEmpty(b))n.bodyparts=b;else throw"Use Bodyparts as bodyParts argument, must contain at least one property";if(c&&g.isArray(c)&&!g.isEmpty(c))n.to=c;else throw"Recipients is required parameter, must be a nonempty array";if(d)if(g.isArray(d))g.isEmpty(d)||(n.attachment=d);else throw"Attachments must be an array of file IDs from File Service";return e._ajax({method:"POST",url:this.restUrl+"/email",isAsync:k,asyncHandler:h,data:JSON.stringify(n)})},cancel:function(a,b){return e._ajax({method:"DELETE",
url:this.restUrl+"/"+a,isAsync:null!=b,asyncHandler:new n(u)})},registerDevice:function(a,b,c){var d=l(arguments),f=null!=d,m=h()?window.device:NodeDevice,k={deviceToken:null,deviceId:m.uuid,os:m.platform,osVersion:m.version};g.isArray(a)&&(k.channels=a);for(var m=0,n=arguments.length;m<n;++m){var p=arguments[m];if(g.isNumber(p)||p instanceof Date)k.expiration=p instanceof Date?p.getTime()/1E3:p}var q=this.restUrl+"/registrations";cordova.exec(function(a){k.deviceToken=a;e._ajax({method:"POST",url:q,
data:JSON.stringify(k),isAsync:f,asyncHandler:d})},function(a){console.warn(JSON.stringify(["failed to register ",a]))},"PushNotification","registerDevice",[{projectid:"http://backendless.com",appid:e.applicationId}])},getRegistrations:function(a){var b=h()?window.device.uuid:NodeDevice.uuid,c=l(arguments);return e._ajax({method:"GET",url:this.restUrl+"/registrations/"+b,isAsync:null!=c,asyncHandler:c})},unregisterDevice:function(a){var b=h()?window.device.uuid:NodeDevice.uuid,c=l(arguments),b=e._ajax({method:"DELETE",
url:this.restUrl+"/registrations/"+b,isAsync:null!=c,asyncHandler:c});try{cordova.exec(u,u,"PushNotification","unregisterDevice",[])}catch(d){console.log(d.message)}return b}};M.prototype={saveFile:function(a,b,c,d,f){if(!a||!g.isString(a))throw Error('Missing value for the "path" argument. The argument must contain a string value');if(!b||!g.isString(a))throw Error('Missing value for the "fileName" argument. The argument must contain a string value');d instanceof e.Async&&(f=d,d=null);c instanceof
File||(c=new Blob([c]));if(28E5<c.size)throw Error("File Content size must be less than 2,800,000 bytes");a=this.restUrl+"/binary/"+a+(g.isString(b)?"/"+b:"")+(d?"?overwrite=true":"");try{var h=new FileReader;h.fileName=b;h.uploadPath=a;h.onloadend=T;f&&(h.asyncHandler=f);h.onerror=function(a){f.fault(a)};h.readAsDataURL(c);if(!f)return!0}catch(k){console.log(k)}},upload:function(a,b,c){a=a.files||a;b=this.restUrl+"/"+b+"/";if(h())if(window.File&&window.FileList){a instanceof File&&(a=[a]);for(var d=
0,e=0,g=a.length;e<g;e++)try{var k=new FileReader;k.fileName=a[e].name;k.uploadPath=b+k.fileName;k.onloadend=S;k.asyncHandler=c;k.onerror=function(a){c.fault(a)};k.readAsBinaryString(a[e])}catch(l){d++}}else d=document.createElement("iframe"),d.id=d.name="ifr"+(new Date).getTime(),d.width=d.height="0",document.body.appendChild(d),k=document.createElement("form"),k.target=d.name,k.enctype="multipart/form-data",k.method="POST",document.body.appendChild(k),k.appendChild(a),a=a.value,(d=a.lastIndexOf("\\"))&&
(a=a.substring(d+1)),k.action=b+a,k.submit();else throw"Upload File not supported with NodeJS";},remove:function(a,b){var c=l(arguments),d=null!=c,f=0==a.indexOf("http://")||0==a.indexOf("https://")?a:this.restUrl+"/"+a;e._ajax({method:"DELETE",url:f,isAsync:d,asyncHandler:c})},removeDirectory:function(a,b){var c=l(arguments);e._ajax({method:"DELETE",url:this.restUrl+"/"+a,isAsync:null!=c,asyncHandler:c})}};x.prototype._wrapAsync=function(a){return new n(function(b){a.success(b)},function(b){a.fault(b)})};
x.prototype.validatePlayPurchase=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Product Id, Token must be provided and must be not an empty STRING!");for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Product Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),h=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"GET",url:this.restUrl+"/validate/"+a+"/inapp/"+b+"/purchases/"+c,isAsync:h,
asyncHandler:f})};x.prototype.cancelPlaySubscription=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),h=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"POST",url:this.restUrl+"/"+a+"/subscription/"+
b+"/purchases/"+c+"/cancel",isAsync:h,asyncHandler:f})};x.prototype.getPlaySubscriptionStatus=function(a,b,c,d){if(3>arguments.length)throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");for(var f=arguments.length-2;0<=f;f--)if(!arguments[f]||!g.isString(arguments[f]))throw Error("Package Name, Subscription Id, Token must be provided and must be not an empty STRING!");var f=l(arguments),h=null!=f;f&&(f=this._wrapAsync(f));return e._ajax({method:"GET",
url:this.restUrl+"/"+a+"/subscription/"+b+"/purchases/"+c,isAsync:h,asyncHandler:f})};F.prototype._wrapAsync=function(a){return new n(function(b){a.success(b)},function(b){a.fault(b)})};F.prototype.dispatch=function(a,b,c){if(!a||!g.isString(a))throw Error("Event Name must be provided and must be not an empty STRING!");b=g.isObject(b)?b:{};var d=l(arguments),f=null!=d;d&&(d=this._wrapAsync(d));b=b instanceof e.Async?{}:b;return e._ajax({method:"POST",url:this.restUrl+"/"+a,data:JSON.stringify(b),
isAsync:f,asyncHandler:d})};var P=function(){},Q=[];P.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){return a},put:function(a,b,c,d){if(!g.isString(a))throw Error("You can use only String as key to put into Cache");if(c)if("object"==typeof c&&!d)d=c,c=null;else if("number"!=typeof c)throw Error("You can use only String as timeToLive attribute to put into Cache");d=l([b,d]);var f=!1;null!=
d&&(f=!0,d=this._wrapAsync(d));g.isObject(b)&&b.constructor!==Object&&(b.___class=b.___class||w.call(b));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+(c?"?timeout="+c:""),data:JSON.stringify(b),isAsync:f,asyncHandler:d})},expireIn:function(a,b,c){if(g.isString(a)&&(g.isNumber(b)||g.isDate(b))&&b){b=g.isDate(b)?b.getTime():b;var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+"/expireIn?timeout="+
b,data:JSON.stringify({}),isAsync:f,asyncHandler:d})}throw Error('The "key" argument must be String. The "seconds" argument can be either Number or Date');},expireAt:function(a,b,c){if(g.isString(a)&&(g.isNumber(b)||g.isDate(b))&&b){b=g.isDate(b)?b.getTime():b;var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:"PUT",url:e.serverURL+"/"+e.appVersion+"/cache/"+a+"/expireAt?timestamp="+b,data:JSON.stringify({}),isAsync:f,asyncHandler:d})}throw Error("You can use only String as key while expire in Cache. Second attribute must be declared and must be a Number or Date type");
...
url:e.serverURL+"/"+e.appVersion+"/cache/"+a,isAsync:d,asyncHandler:c});if(g.isObject(c)&&c.___class){var f;try{f=new (eval(c.___class))(c)}catch(h){f=new Q[c.___class](c)}return f}return c},remove:function(a,b){return this.cacheMethod("DELETE",a,!1,b)},setObjectFactory:function(a,b){Q[a]=b}};var r=function(){},R=function(a){this.name=a};r.prototype={_wrapAsync:function(a){var b=this;return new n(function(c){c=b._parseResponse(c);a.success(c)},function(b){a.fault(b)})},_parseResponse:function(a){return a},
of:function(a){return new R(a)},getConstructor:function(){return this},counterNameValidation:function(a,b){if(!a)throw Error('Missing value for the "counterName" argument. The argument must contain a string value.');if(!g.isString(a))throw Error('Invalid value for the "value" argument. The argument must contain only string values');this.name=a},implementMethod:function(a,b,c){var d=l(arguments),f=!1;null!=d&&(f=!0,d=this._wrapAsync(d));return e._ajax({method:a,url:e.serverURL+"/"+e.appVersion+"/counters/"+
