...
gulp.task('bb8-css', function(){
    gulp.src([
        ...
        .pipe(stylus({compress: true}))
        .pipe(rename({suffix: '.min'}))
        .pipe(gulp.dest('D:/OpenServer/domains/sites/bb8/backend/application/views/blocks/library.blocks/dropdown/'))
});
